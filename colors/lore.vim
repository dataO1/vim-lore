...
let s:theme.shade3 = 'd79921'
let s:theme.shade4 = 'fabd2f'

let s:theme.accent1 = '689d6a'
let s:theme.accent2 = 'f18e5e'
let s:theme.accent3 = 'd48190'

let s:theme.green = '689d6a'
let s:theme.red = 'e84231'
let s:theme.orange = 'fc5e03'
let s:theme.yellow = 'fabd2f'
